...
# change names in post.burnin 
# Blattodea to Blattodea including Isoptera
# Blattodea sensu stricto to Blattodea excluding Isoptera

names(post.burnin)[which(names(post.burnin) == "Blattodea")] <- "Blattodea including Isoptera"

names(post.burnin)[which(names(post.burnin) == "Blattodea sensu stricto")] <- "Blattodea excluding Isoptera"
...
grid.arrange(grobs = c(plots[c(1:6)]), ncol = 3)
