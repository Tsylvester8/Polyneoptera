...
# save the results
save.image("../results/phasmatodea.correction.RData")
...
load("../results/order.rates4-5.RData")

# keep all but the rates
rm(list = ls()[c(-12,-18)])

# load corrected phasmatodea runs
load("../results/phasmatodea.correction.RData")
...
save.image("../results/order.rates.4-5.corrected.RData")
