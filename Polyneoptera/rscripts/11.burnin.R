...
load("../results/blat.iso.comb.rates.RData")
...
load("../results/order.rates1-3.RData")
...
load("../results/order.rates.4-5.corrected.RData")
...
# save image
save.image("../results/post.burnin.RData")
